...
def run_analysis():
    ...
    def upd(msg, pct):
        ...
        prog.markdown(prog_html(msg, pct, _log_lines), unsafe_allow_html=True)
...
def render_tab_overview():
    ...
    st.markdown(section_lbl("RESULTADO DAS PARTIDAS"), unsafe_allow_html=True)
    st.markdown(donut_svg(wins, draws, losses), unsafe_allow_html=True)
    ...
    st.markdown('<div class="ds-card">', unsafe_allow_html=True)
    st.markdown(section_lbl("PERFIL DE HABILIDADES"), unsafe_allow_html=True)
    ...
    st.markdown('<div class="ds-card">', unsafe_allow_html=True)
    st.markdown(section_lbl("TAXA DE VITÓRIA POR COR"), unsafe_allow_html=True)
    for lbl, pct, col, gc in [
        ...
        st.markdown(
            ...
            f'</div>'
            + color_bar(pct, col, height=16, show_label=False) +
            f'</div>',
            unsafe_allow_html=True,
        )
...
def render_tab_errors():
    ...
    st.markdown('<div class="ds-card">', unsafe_allow_html=True)
    st.markdown(section_lbl("QUALIDADE DOS LANCES — MÉDIA POR PARTIDA"), unsafe_allow_html=True)
    ...
    st.markdown('<div class="ds-card">', unsafe_allow_html=True)
    st.markdown(section_lbl("BLUNDERS POR FASE DA PARTIDA"), unsafe_allow_html=True)
    ...
    _MAX_TAC = 20
    st.markdown('<div class="ds-card">', unsafe_allow_html=True)
    st.markdown(section_lbl("PADRÕES TÁTICOS MAIS IGNORADOS"), unsafe_allow_html=True)
...
def _opening_section(title: str, openings: list, best_key: str, worst_key: str):
    ...
    st.markdown(section_lbl(title), unsafe_allow_html=True)
    ...
    for op in openings[:6]:
        ...
        st.markdown(
            ...
            f'</div></div>'
            + color_bar(pct, color, height=10, show_label=False) +
            f'</div>',
            unsafe_allow_html=True,
        )
    st.markdown('</div>', unsafe_allow_html=True)
    ...
    if strong_white:
        ...
        for op in strong_white:
            ...
            st.markdown(
                ...
                f'</div></div>'
                + color_bar(wr_op, C["red"], height=8, show_label=False) +
                f'</div>',
                unsafe_allow_html=True,
            )
        st.markdown('</div>', unsafe_allow_html=True)
